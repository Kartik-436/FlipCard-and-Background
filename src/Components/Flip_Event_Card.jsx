            ...
            <div onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className='card relative inline-block w-fit'>
                ...
                <div className='front'>
                    <div className="h-[76vh] w-[30vw] redcard rounded-2xl p-[5%] flex flex-col gap-10" >
                        <div className='flex flex-col gap-2 h-[35%]'>
                            <div>
                            ...
                            <div className='flex items-center justify-start gap-4'>
                                <span className='px-[1.5vw] py-[0.1vw] border-black border-[1.6px] scale-y-105 rounded-full text-[1.15vw] uppercase'>{props.Box1}</span>
                                <span className='px-[1.5vw] py-[0.1vw] border-black border-[1.6px] rounded-full scale-y-105 text-[1.15vw] uppercase'>{props.Box2}</span>
                            </div>
                        </div>

                        <div className='h-[65%]'>
                            <img src={props.ImgLink} alt="" className='border-black border-[1.6px] z-50 w-[99.5%] h-[100%] rounded-2xl' />
                        </div>
                    </div>
                </div>
                ...
                <div className='back absolute top-0'>
                    <div className="h-[76vh] w-[30vw] bg-[#333] rounded-2xl p-[5%] text-[#e7e7e7] flex flex-col gap-10" >
                        <div className='flex flex-col gap-2 h-[35%]'>
                            ...
                            <div className='flex items-center justify-start gap-4'>
                                <span className='px-[1.5vw] py-[0.1vw] border-white border-[1.6px] scale-y-105 rounded-full text-[1.15vw] uppercase'>{props.Box1}</span>
                                <span className='px-[1.5vw] py-[0.1vw] border-white border-[1.6px] rounded-full scale-y-105 text-[1.15vw] uppercase'>{props.Box2}</span>
                            </div>
                        </div>

                        <div className='flex flex-col gap-5 items-center justify-between h-[65%]'>
